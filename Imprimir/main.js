const demostrarCapacidades = async (macImpresora, licencia) => {
    ...
    conector
        ...
        .EstablecerAlineacion(ConectorEscposAndroid.ALINEACION_CENTRO)
        .Feed(1)
        .ImprimirCodigoDeBarras("code128", "Carbonería La Privadita", ConectorEscposAndroid.TAMAÑO_IMAGEN_NORMAL, 320, 50)
        .Iniciar()
        .EstablecerAlineacion(ConectorEscposAndroid.ALINEACION_CENTRO)
        .Feed(1)
        .EstablecerTamañoFuente(1, 1)
        .EscribirTexto("Carbonería La Privadita\n")
        .Feed(2)
        .Corte(1)
        .Pulso(48, 60, 120)
